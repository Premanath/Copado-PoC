({
        ...
        action.setParams({"clientId" : clientId,
         ...
         action.setCallback(this, function(response) {
            ...
            if (component.isValid() && state === "SUCCESS") {
                ...
                if (errors) {
                    console.error("profileThreeStateAttributeCategoryViewHelper: getAppliedAttributes encountered error:");
                    console.error(errors);
                    if (errors[0] && errors[0].message) {
                        console.error("profileThreeStateAttributeCategoryViewHelper: getAppliedAttributes: Error message: " +
                                 errors[0].message);
                    }
                } else {
                    console.error("profileThreeStateAttributeCategoryViewHelper: getAppliedAttributes: Unknown error");
                }
    ...
    updateAppliedAttribute: function(component, clientId, attributeCategoryCode, attributeName, appliedAttributeCode, changedValue) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (component.isValid() && state === "SUCCESS") {
                ...
                var errors = response.getError();
                if (errors) {
                    console.error("profileThreeStateAttributeCategoryViewHelper: updateAppliedAttribute encountered error:");
                    console.error(errors);
                    if (errors[0] && errors[0].message) {
                        console.error("profileThreeStateAttributeCategoryViewHelper: updateAppliedAttribute: Error message: " +
                                 errors[0].message);
                    }
                } else {
                    console.error("profileThreeStateAttributeCategoryViewHelper: updateAppliedAttribute: Unknown error");
                }
    ...
    parseResultSet2JSON: function(resultSetString) {
        if (typeof resultSetString === 'undefined' || !resultSetString) {
            console.error("profileThreeStateAttributeCategoryViewHelper: resultSetString null or empty.  resultSetString skipped!");
            return null;
        }
        ...
        try {
            ...
            console.error("profileThreeStateAttributeCategoryViewHelper: resultSetString has INVALID json format and is skipped: " + resultSetString);
            console.error(e);
            return null;
        }
    }
