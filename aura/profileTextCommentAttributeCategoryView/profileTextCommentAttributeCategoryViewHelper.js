({
    getAppliedAttributes: function(component, clientId, attributeCategoryCode) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (component.isValid() && state === "SUCCESS") {
                ...
                if (errors) {
                    console.error("profileTextCommentAttributeCategoryViewHelper: getAppliedAttributes encountered error:");
                    console.error(errors);
                    if (errors[0] && errors[0].message) {
                        console.error("profileTextCommentAttributeCategoryViewHelper: getAppliedAttributes: Error message: " +
                                 errors[0].message);
                    }
                } else {
                    console.error("profileTextCommentAttributeCategoryViewHelper: getAppliedAttributes: Unknown error");
                }
    ...
    updateAppliedAttribute: function(component, clientId, attributeCategoryCode, attributeName, appliedAttributeCode, changedValue) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (component.isValid() && state === "SUCCESS") {
                ...
                var errors = response.getError();
                if (errors) {
                    console.error("profileTextCommentAttributeCategoryViewHelper: updateAppliedAttribute encountered error:");
                    console.error(errors);
                    if (errors[0] && errors[0].message) {
                        console.error("profileTextCommentAttributeCategoryViewHelper: updateAppliedAttribute: Error message: " +
                                 errors[0].message);
                    }
                } else {
                    console.error("profileTextCommentAttributeCategoryViewHelper: updateAppliedAttribute: Unknown error");
                }
    ...
    parseResultSet2JSON: function(resultSetString) {
        if (typeof resultSetString === 'undefined' || !resultSetString) {
            console.error("profileTextCommentAttributeCategoryViewHelper: resultSetString null or empty.  resultSetString skipped!");
            return null;
        }
        ...
        try {
            ...
            console.error("profileTextCommentAttributeCategoryViewHelper: resultSetString has INVALID json format and is skipped: " + resultSetString);
            console.error(e);
            return null;
        }
    }
